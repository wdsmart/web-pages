I run the <a href="http://research.engr.oregonstate.edu/prg/">Personal Robotics Group</a> here at Oregon State.  Most of the research that we do centers around how robots and people interact, how we can integrate robots and automation into our daily lives, and how we can get robots to do useful work for long periods of time.  You can find out more about the group on our <a target="_blank" href="http://research.engr.oregonstate.edu/prg/">web pages</a> and on my <a href="papers.php">publications page</a>.




<h2>Joining the Personal Robotics Group</h2>
...
<dl>
	<dt><b>Can I work in your lab?</b></dt>
	<dd>
	...
	<dt><b>What about mathematics background?</b></dt>
	<dd>
	...
	<dt><b>I'm still here. What now?</b></dt>
	<dd>
		If you've made it this far, then you must still be interested. Don't worry too much if you don't meet all of the criteria above. If you meet most of them, then <?php email('send me an email'); ?>, and we can discuss things.
	</dd>
</dl>
...
<dl>
	<dt><b>Will you be my Ph.D. advisor?</b></dt>
	<dd>
	...
	<dt><b>But, our research interests really overlap!</b></dt>
	<dd>
		If you're a prospective graduate student and your research interests seriously overlap with mine, then <?php email('send me an email'); ?>, and <b>briefly</b> tell me about yourself, so that I know to be on the lookout for your application packet when it arrives. Letters with full CVs or ones that don't mention specific research issues will be ignored. Telling me that you &quot;read my web pages&quot; and &quot;our research interests overlap&quot; doesn't count. Email without my address in the <code>To:</code> line will also tend to get ignored, since that usually means a mass mailing. Finally, you should put the word &quot;Sisyphus&quot; at the start of the subject line; that way, I can identify the people who have taken the time to actually read this page, and weed out those just sending mass emails. If you don't have this word in your subject line, I will not read your email. I'm sorry to make this so onerous, but I get an overwhelming amount of email from prospective students, and I don't have time to read all of the ones generated by scraping the University web pages.
	</dd>

	<dt><b>I'm a current graduate student at Oregon State. Can I check out your lab?</b></dt>
	<dd>
		If you're currently a graduate student at Oregon State and you're interesting in talking about working with me, <?php email('send me a brief email') ?>, and we can take it from there.
	</dd>
</dl>
